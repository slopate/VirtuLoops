...
// Reports if hand is active, i.e. if it's playing an instrument
public class ActiveHand : MonoBehaviour
{
    // These bools are changed in other functions and then constantly sent to Max from this script
